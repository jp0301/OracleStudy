...
-- 각각의 데이터를 테이블의 형태로 연결시켜 저장 해놓은 구조
...
FROM EMP
WHERE DEPTNO LIKE 20; -- DEPTNO = 20
--==>>
/*
...
SELECT EMPNO AS "사원번호", ENAME "사원명", JOB 직종명, SAL "급     여", DEPTNO "부서번호" -- AS 생략가능, 큰따옴표 생략가능
FROM EMP;
