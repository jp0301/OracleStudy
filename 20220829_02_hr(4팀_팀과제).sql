...
INSERT INTO REGIONS4(REGION_ID, REGION_NAME)
VALUES(1, 'Europe');
...
-- JOBS4 코멘트 설정
COMMENT ON TABLE JOBS4  IS 'jobs table with job titles and salary ranges. Contains 19 rows.
References with employees and job_history table.';
COMMENT ON COLUMN JOBS4.JOB_ID IS 'Primary key of jobs table.';
COMMENT ON COLUMN JOBS4.JOB_TITLE IS 'A not null column that shows job title, e.g. AD_VP, FI_ACCOUNTANT';
COMMENT ON COLUMN JOBS4.MIN_SALARY IS 'Minimum salary for a job title.';
COMMENT ON COLUMN JOBS4.MAX_SALARY IS 'Maximum salary for a job title';
...
ADD ( CONSTRAINT COUNTRIES4_C_ID_PK PRIMARY KEY(COUNTRY_ID));


ALTER TABLE COUNTRIES4
MODIFY COUNTRY_ID CONSTRAINT COUNTRY4_ID_NN NOT NULL;

ALTER TABLE COUNTRIES4
ADD ( CONSTRAINT COUNTRIES4_REG4_FK FOREIGN KEY(REGION_ID) 
...
-- COUNTIRES4 COMMENT 입력
COMMENT ON COLUMN COUNTRIES4.COUNTRY_ID IS 'Primary key of countries table.';
COMMENT ON COLUMN COUNTRIES4.COUNTRY_NAME IS 'Country name';
COMMENT ON COLUMN COUNTRIES4.REGION_ID IS 'Region ID for the country. Foreign key to region_id column in the departments table.';
COMMENT ON TABLE COUNTRIES4  IS 'country table. Contains 25 rows. References with locations table.';
...
--2. 테이블 생성(컬럼이름, 자료형, DAFAULT 표현식 NULL등...)
...
VALUES (LOCATIONS4_SEQ.NEXTVAL,'1297 Via Cola di Rie','00989','Roma',null,'IT');
INSERT INTO LOCATIONS4(LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID)
VALUES (LOCATIONS4_SEQ.NEXTVAL,'93091 Calle della Testa','10934','Venice',null,'IT');
INSERT INTO LOCATIONS4(LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID)
VALUES (LOCATIONS4_SEQ.NEXTVAL,'2017 Shinjuku-ku','1689','Tokyo','Tokyo Prefecture','JP');
INSERT INTO LOCATIONS4(LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID)
VALUES (LOCATIONS4_SEQ.NEXTVAL,'9450 Kamiya-cho','6823','Hiroshima',null,'JP');
INSERT INTO LOCATIONS4(LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID)
VALUES (LOCATIONS4_SEQ.NEXTVAL,'2014 Jabberwocky Rd','26192','Southlake','Texas','US');
INSERT INTO LOCATIONS4(LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID)
VALUES (LOCATIONS4_SEQ.NEXTVAL,'2011 Interiors Blvd','99236','South San Francisco','California','US');
INSERT INTO LOCATIONS4(LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID)
VALUES (LOCATIONS4_SEQ.NEXTVAL,'2007 Zagora St','50090','South Brunswick','New Jersey','US');
INSERT INTO LOCATIONS4(LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID)
VALUES (LOCATIONS4_SEQ.NEXTVAL,'2004 Charade Rd','98199','Seattle','Washington','US');
INSERT INTO LOCATIONS4(LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID)
VALUES (LOCATIONS4_SEQ.NEXTVAL,'147 Spadina Ave','M5V 2L7','Toronto','Ontario','CA');
INSERT INTO LOCATIONS4(LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID)
VALUES (LOCATIONS4_SEQ.NEXTVAL,'6092 Boxwood St','YSW 9T2','Whitehorse','Yukon','CA');
INSERT INTO LOCATIONS4(LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID)
VALUES (LOCATIONS4_SEQ.NEXTVAL,'40-5-12 Laogianggen','190518','Beijing',null,'CN');
INSERT INTO LOCATIONS4(LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID)
VALUES (LOCATIONS4_SEQ.NEXTVAL,'1298 Vileparle (E)','490231','Bombay','Maharashtra','IN');
INSERT INTO LOCATIONS4(LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID)
VALUES (LOCATIONS4_SEQ.NEXTVAL,'12-98 Victoria Street','2901','Sydney','New South Wales','AU');
INSERT INTO LOCATIONS4(LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID)
VALUES (LOCATIONS4_SEQ.NEXTVAL,'198 Clementi North','540198','Singapore',null,'SG');
INSERT INTO LOCATIONS4(LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID)
VALUES (LOCATIONS4_SEQ.NEXTVAL,'8204 Arthur St',null,'London',null,'UK');
INSERT INTO LOCATIONS4(LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID)
VALUES (LOCATIONS4_SEQ.NEXTVAL,'Magdalen Centre, The Oxford Science Park','OX9 9ZB','Oxford','Oxford','UK');
INSERT INTO LOCATIONS4(LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID)
VALUES (LOCATIONS4_SEQ.NEXTVAL,'9702 Chester Road','09629850293','Stretford','Manchester','UK');
INSERT INTO LOCATIONS4(LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID)
VALUES (LOCATIONS4_SEQ.NEXTVAL,'Schwanthalerstr. 7031','80925','Munich','Bavaria','DE');
INSERT INTO LOCATIONS4(LOCATION_ID, STREET_ADDRESS, POSTAL_CODE, CITY, STATE_PROVINCE, COUNTRY_ID)
VALUES(LOCATIONS4_SEQ.NEXTVAL, 'Rua Frei Caneca 1360 ', '01307-002', 'Sao Paulo', 'Sao Paulo', 'BR');
INSERT INTO LOCATIONS4(LOCATION_ID, STREET_ADDRESS, POSTAL_CODE, CITY, STATE_PROVINCE, COUNTRY_ID)
VALUES(LOCATIONS4_SEQ.NEXTVAL, '20 Rue des Corps-Saints', '1730', 'Geneva', 'Geneve', 'CH');
INSERT INTO LOCATIONS4(LOCATION_ID, STREET_ADDRESS, POSTAL_CODE, CITY, STATE_PROVINCE, COUNTRY_ID)
VALUES(LOCATIONS4_SEQ.NEXTVAL, 'Murtenstrasse 921', '3095', 'Bern', 'BE', 'CH');
INSERT INTO LOCATIONS4(LOCATION_ID, STREET_ADDRESS, POSTAL_CODE, CITY, STATE_PROVINCE, COUNTRY_ID)
VALUES(LOCATIONS4_SEQ.NEXTVAL, 'Pieter Breughelstraat 837', '3029SK', 'Utrecht', 'Utrecht', 'NL');
INSERT INTO LOCATIONS4(LOCATION_ID, STREET_ADDRESS, POSTAL_CODE, CITY, STATE_PROVINCE, COUNTRY_ID)
VALUES(LOCATIONS4_SEQ.NEXTVAL, 'Mariano Escobedo 9991', '11932', 'Mexico City', 'Distrito Federal,', 'MX');

--코멘트 추가
COMMENT ON TABLE LOCATIONS4  IS 'Locations table that contains specific address of a specific office,
warehouse, and/or production site of a company. Does not store addresses /
locations of customers. Contains 23 rows; references with the
departments and countries tables. ';
COMMENT ON COLUMN LOCATIONS4.LOCATION_ID IS 'Primary key of locations table';
COMMENT ON COLUMN LOCATIONS4.STREET_ADDRESS IS 'Street address of an office, warehouse, or production site of a company.
Contains building number and street name';
COMMENT ON COLUMN LOCATIONS4.POSTAL_CODE IS 'Postal code of the location of an office, warehouse, or production site
of a company.';
COMMENT ON COLUMN LOCATIONS4.CITY IS 'A not null column that shows city where an office, warehouse, or
production site of a company is located.';
COMMENT ON COLUMN LOCATIONS4.STATE_PROVINCE IS 'State or Province where an office, warehouse, or production site of a
company is located.';
COMMENT ON COLUMN LOCATIONS4.COUNTRY_ID IS 'Country where an office, warehouse, or production site of a company is
...
ALTER TABLE DEPARTMENTS4
DROP CONSTRAINT DEPARTMENTS4_MANAGER_ID_FK ;

--4. 데이터 입력

INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Administration',200,1700);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Marketing',201,1800);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Purchasing',114,1700);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Human Resources',203,2400);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Shipping',121,1500);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'IT',103,1400);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Public Relations',204,2700);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Sales',145,2500);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Executive',100,1700);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Finance',108,1700);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Accounting',205,1700);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Treasury',1700);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Corporate Tax',1700);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Control And Credit',1700);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Shareholder Services',1700);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Benefits',1700);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Manufacturing',1700);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Construction',1700);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Contracting',1700);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Operations',1700);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'IT Support',1700);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'NOC',1700);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'IT Helpdesk',1700);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Government Sales',1700);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Retail Sales',1700);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Recruiting',1700);
INSERT INTO DEPARTMENTS4(DEPARTMENT_ID, DEPARTMENT_NAME, LOCATION_ID)
VALUES (DEPARTMENTS4_SEQ.NEXTVAL,'Payroll',1700);

-- DEPARTMENTS4 COMMENT 입력
COMMENT ON TABLE DEPARTMENTS4 IS 'Departments table that shows details of departments where employees
work. Contains 27 rows; references with locations, employees, and job_history tables.';
COMMENT ON COLUMN DEPARTMENTS4.DEPARTMENT_ID IS 'Primary key column of departments table.';
COMMENT ON COLUMN DEPARTMENTS4.DEPARTMENT_NAME IS 'A not null column that shows name of a department. Administration,
Marketing, Purchasing, Human Resources, Shipping, IT, Executive, Public
Relations, Sales, Finance, and Accounting.';
COMMENT ON COLUMN DEPARTMENTS4.MANAGER_ID IS 'Manager_id of a department. Foreign key to employee_id column of employees table. The manager_id column of the employee table references this column.';
COMMENT ON COLUMN DEPARTMENTS4.LOCATION_ID IS 'Location id where a department is located. Foreign key to location_id column of locations table.';
...
INSERT INTO EMPLOYEES4 (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID)
VALUES (EMPLOYEES4_SEQ.NEXTVAL,'Steven','King','SKING','515.123.4567',TO_DATE('2003-06-17','YYYY-MM-DD'),'AD_PRES','24000',NULL,NULL,'90');
INSERT INTO EMPLOYEES4 (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID)
VALUES (EMPLOYEES4_SEQ.NEXTVAL,'Neena','Kochhar','NKOCHHAR','515.123.4568',TO_DATE('2005-09-21','YYYY-MM-DD'),'AD_VP','17000',NULL,'100','90');
...
-- EMPLOYEES4 COMMENT 설정
COMMENT ON COLUMN EMPLOYEES4.EMPLOYEE_ID IS 'Primary key of employees table.';
COMMENT ON COLUMN EMPLOYEES4.FIRST_NAME IS 'First name of the employee. A not null column.';
COMMENT ON COLUMN EMPLOYEES4.LAST_NAME IS 'Last name of the employee. A not null column.';
COMMENT ON COLUMN EMPLOYEES4.EMAIL IS 'Email id of the employee';
COMMENT ON COLUMN EMPLOYEES4.PHONE_NUMBER IS 'Phone number of the employee; includes country code and area code';
COMMENT ON COLUMN EMPLOYEES4.HIRE_DATE IS 'Date when the employee started on this job. A not null column.';
COMMENT ON COLUMN EMPLOYEES4.JOB_ID IS '"Current job of the employee; foreign key to job_id column of the
jobs table. A not null column."';
COMMENT ON COLUMN EMPLOYEES4.SALARY IS '"Monthly salary of the employee. Must be greater
than zero (enforced by constraint emp_salary_min)"';
COMMENT ON COLUMN EMPLOYEES4.COMMISSION_PCT IS '"Commission percentage of the employee; Only employees in sales
department elgible for commission percentage"';
COMMENT ON COLUMN EMPLOYEES4.MANAGER_ID IS '"Manager id of the employee; has same domain as manager_id in
departments table. Foreign key to employee_id column of employees table.
(useful for reflexive joins and CONNECT BY query)"';
COMMENT ON COLUMN EMPLOYEES4.DEPARTMENT_ID IS '"Department id where employee works; foreign key to department_id
column of the departments table"';
COMMENT ON TABLE EMPLOYEES4 IS 'employees table. Contains 107 rows. References with departments,
